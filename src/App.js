...
// import ChatCardListing from "./component/ChatCardListing/ChatCardListing";
...
//   const [cookie, setCookie, removeCookie] = useCookies(["whatsappclone"]);
            ...
            <div className="App">
              <Router>
                <div className="left-side">
                  ...
                  <SearchPeople />
                  <ChatCardListing friendsList={friendsList} />
                </div>
                <Switch>
                  <Route path="/:id">
                    <div className="right-side">
